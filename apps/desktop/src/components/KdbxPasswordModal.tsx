...
export default function KdbxPasswordModal({ onConfirm, onCancel, error, theme = "dark", accentColor = "yellow" }: KdbxPasswordModalProps) {
    ...
    <div className="fixed inset-0 bg-black/60 backdrop-blur-[2px] flex items-center justify-center z-50 p-4">
      <div className="bg-[#0a0a0a] border border-[#1a1a1a] rounded-2xl p-6 w-full max-w-sm">
        <div className="flex items-center gap-4 mb-5">
          <div className={`w-10 h-10 rounded-xl ${accentClasses.lightClass} border-2 ${accentClasses.borderClass} flex items-center justify-center shrink-0`}>
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              ...
              autoFocus
              className={`w-full bg-[#0a0a0a] border border-[#1a1a1a] rounded-lg px-4 py-2 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 ${accentClasses.focusRingClass} focus:${accentClasses.borderClass} transition-all`}
        ...
        <div className="flex items-center gap-2 mt-5">
          ...
          <button
            ...
            disabled={!password}
            className={`flex-1 px-4 py-2.5 ${accentClasses.bgClass} ${accentClasses.hoverBgClass} text-black rounded-lg text-sm font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed`}
          >
            Unlock
          </button>
        </div>
