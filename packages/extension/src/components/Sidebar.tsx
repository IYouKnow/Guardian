                        ...
                        {categories.map((category) => (
                            <li key={category}>
                                <button
                                    ...
                                    className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-all ${activeCategory === category && !showSettings
                ...
                <div className={`border-t ${themeClasses.border} pt-4`}>
                    <ul className="space-y-1">
                        <li>
                            <button
                                onClick={onSettings}
                                className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-all flex items-center gap-2 ${showSettings
                                    ? `${themeClasses.activeBg} ${accentClasses.textClass}`
                                    : `${themeClasses.textSecondary} ${themeClasses.hoverBg} ${themeClasses.hoverText}`
                                    }`}
                            >
