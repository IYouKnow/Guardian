...
export default function Layout({ children, currentPageName }: LayoutProps) {
  ...
  const currentNavItem = getAllItems().find((item) => item.page === currentPageName);
    ...
    <div className={`h-screen overflow-hidden ${themeClasses.bg} transition-all duration-300`}>
      ...
      `}>
        <div className="flex flex-col h-full">
          ...
          <nav className={`flex-1 p-2 lg:p-3 space-y-1 overflow-y-auto scrollbar-hide`}>
                ...
                <div key={section.id} className="mb-2">
                  <button
                    ...
                    className={`
                      ...
                      ${themeClasses.textTertiary} hover:${themeClasses.text} hover:${themeClasses.hoverBg}
                      transition-all duration-150 text-xs uppercase tracking-wider font-semibold
                    `}
                  >
